...
const ADMIN_NAVIGATION = [['availability', 'Resource Availability', 'utility:clock'], ['resources', 'Doctors / Resources', 'utility:user'], ['locations', 'Locations', 'utility:location'], ['settings', 'Settings', 'utility:settings']];
